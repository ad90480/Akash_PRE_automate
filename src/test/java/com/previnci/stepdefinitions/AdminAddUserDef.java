...
////        WebElement verifyUserEmail = this.addUser.userEmailVerify();
////      //  WebElement filledUserEMail = this.addUser.getEmailElement();
////        System.out.println(filledUserEMail);
////        System.out.println(verifyUserEmail);
////        basePage.assertTextEquals(verifyUserEmail, filledUserEMail);
//    }
//
